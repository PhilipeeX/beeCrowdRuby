=begin
    ...
    até que seja digitado um valor maior do que X para ele). Conte quantos números inteiros devem ser somados em 
        sequência (considerando o X nesta soma) para que a soma ultrapasse a Z o mínimo possível. Escreva o valor 
        final da contagem.
...
## criar um array que é a soma de x e inserir a cada loop um valor x+1 dentro do array e extrair essa soma.
